...
export type SuggestedUserCardHandle = {
    getNickName: () => string;
    setCheckedFalse: () => void;
};

const SuggestedUserCard = forwardRef<SuggestedUserCardHandle, SuggestedUserCardProps>((props: SuggestedUserCardProps, ref) => {
    ...
    function toggleCheckStatus() {
        ...
        if (newIsCheckedValue) {
            props.addUser(props.nickname);
        }
        else {
            props.removeUser(props.nickname);
        }

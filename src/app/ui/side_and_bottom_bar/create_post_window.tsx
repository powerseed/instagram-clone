...
export default function CreatePostWindow({ closeThisWindow }: { closeThisWindow: Function }) {
    ...
    return (
        <div className="fixed top-0 bottom-0 left-0 right-0 !my-0 w-screen h-screen bg-black/70 z-30">
            <div className="fixed top-1/2 left-1/2 translate-y-[-50%] translate-x-[-50%] w-4/5 max-w-[591px] aspect-[0.93]">
                <div ref={thisRef} className='flex flex-col h-full rounded-2xl bg-white opacity-100 text-[14px] divide-y divide-solid'>
